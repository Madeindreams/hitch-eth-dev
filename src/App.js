  ...
  return (
    <div className="App">
      ...
      <h1 className="title"> A Hitchhicker's Guide to Ethereum Development </h1>
       ...
       <p>
         It might be a good idea to start from a fresh OS installation if you’re not familiar with Linux command. This will also prevent some error if you have previous version on your system.
       </p>
      </header>
    </div>
  );
